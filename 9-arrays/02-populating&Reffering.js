...
//arrays can list datatypes in an ordered, nimbered way
...
//recall for-of loop -> give the value of the array
...
// food = food.slice(2, 5); //the first number is the first element to slice from the array, rhile the
...
//flip the values within the array (what was in the index 4 is now 0, 3, to 1, etc.)
